...
/**
 * Criterio di ordinamente decrescente in base al valore dell'edificio privato.
 */
public class ValoreDecrescente implements Comparator<Lotto> {
    /**
    ...
    /**
     * Costruttore ValoreDecrescente.
     *
     * @param centroUrbano
     */
    public ValoreDecrescente(CentroUrbano centroUrbano) {
