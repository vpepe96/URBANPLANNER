...
/**
 * Criterio di ordinamente decrescente in base al valore lessico grafico del nome.
 */
public class NomeLessicoGraficoDecrescente implements Comparator<Lotto> {
    /**
     * {@inheritDoc}
     */
    public int compare(Lotto e1, Lotto e2) {
        ...
        return e2Nome.compareTo(e1Nome);
    }
}
