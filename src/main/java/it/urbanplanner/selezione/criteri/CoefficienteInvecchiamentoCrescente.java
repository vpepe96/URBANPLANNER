...
/**
 * Criterio di ordinamente crescente in base al coefficiente di invecchiamento.
 */
public class CoefficienteInvecchiamentoCrescente implements Comparator<Lotto> {
    /**
     * {@inheritDoc}
     */
